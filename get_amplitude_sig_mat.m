function data = get_amplitude_sig_mat(csi_variable, info_error_to_print)
%   This script is a modified version for reading mat files.
%   csi_variable: CSI File Content
